Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/68b836fc3d25ee944aa7881d4ff7a48c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(3.9,0.06,0,0));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.130239,0.130239,0.08736695,0).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.130239,0.130239,0.08736695,0).a;
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
